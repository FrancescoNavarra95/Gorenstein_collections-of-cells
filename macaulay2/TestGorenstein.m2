...
---------------------------------------------- CONJECTURE TEST ------------------------------------
---------------------------------------------------------------------------------------------------
-- This section provides a routine to test the desired conjecture.
---------------------------------------------------------------------------------------------------
...
--TestGor(L) 
--
-- Given a list L of collections of cells, TestGor verifies the conjecture for every collection in L. 
-- Concretely, for each collection P it checks whether:
